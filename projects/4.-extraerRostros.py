'''
     Primero ejecutamos este programa
     Cuando extraiga los rostros, lo que procede es cambiar el nombre de las imagenes/rostros
     extraidos, con la etiqueta de cada persona.
'''
